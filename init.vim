...
" PLUGINS
"""""""""""""""""""""""""""""""""""""""""""""""""
call plug#begin('~mralians/.config/nvim/plugged')
...
nnoremap <silent>tg :colorscheme desert<CR>
...
inoremap <c-a> <ESc>l<Esc>viw<Esc>a"<Esc>hbi"
nnoremap <leader>f :FZF ~<CR>
nnoremap <leader>rf :RustFmt<CR>

let g:clap_provider_quick_open = {
      \ 'source': ['$MYVIMRC', '~/.spacevim', '~/.bashrc', '~/.tmux.conf'],
      \ 'sink': 'e',
